...
def data_to_save_to_csv(filename, dico_infos):
    ...
    print("==> Creation du fichier :", output_filename)
...
def main(url_livre, filename):
    soup = acces_page(url_livre)
    if soup is None:
        print(f"Pas de données pour : {url_livre}")
        return
    ...
    dico_infos = {}
    dico_infos["product_page_url"] = url_livre
    currency = "£"
